    ...
    <main className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
      <section className="py-12 md:py-[80px] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        <div>
          ...
          <p className="text-base md:text-[18px] leading-relaxed md:leading-[28px] text-text-muted mb-6 md:mb-8">
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4">
            ...
            <Link href="/team">
              <button className="border border-secondary text-secondary px-6 sm:px-8 py-3 sm:py-4 text-[14px] leading-[20px] tracking-[0.05em] font-semibold rounded-sm hover:bg-secondary hover:text-white transition-all uppercase">
                Meet The Partners
              </button>
            </Link>
          </div>
      ...
      <section className="py-12 md:py-[80px]">
        <div className="text-center mb-10 md:mb-16">
          <h2 className="text-2xl md:text-[32px] leading-8 md:leading-[40px] tracking-[-0.01em] font-bold text-text uppercase mb-3 md:mb-4">
            Foundation of Values
          </h2>
          <p className="text-base md:text-[16px] leading-relaxed md:leading-[24px] text-text-muted max-w-2xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 bg-white border border-border p-5 md:p-6 flex flex-col justify-between rounded-sm">
            <div>
          ...
          <div className="bg-white border border-border p-5 md:p-6 rounded-sm">
            <span className="material-symbols-outlined text-secondary text-3xl md:text-4xl mb-4">health_and_safety</span>
            <h3 className="text-xl md:text-[24px] leading-7 md:leading-[32px] font-semibold mb-3 md:mb-4 uppercase">Safety First</h3>
            <p className="text-sm md:text-[16px] leading-relaxed md:leading-[24px] text-text-muted">
          ...
          <div className="bg-white border border-border p-5 md:p-6 rounded-sm">
            <span className="material-symbols-outlined text-accent text-3xl md:text-4xl mb-4">verified</span>
          ...
          <div className="md:col-span-2 bg-secondary text-white p-5 md:p-6 flex flex-col md:flex-row items-center gap-6 md:gap-8 rounded-sm">
      ...
      <section className="py-12 md:py-[80px] bg-white -mx-4 sm:-mx-6 md:-mx-8 px-4 sm:px-6 md:px-8">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start">
          <div className="lg:col-span-4">
            <h2 className="text-2xl md:text-[32px] leading-8 md:leading-[40px] tracking-[-0.01em] font-bold text-text uppercase mb-4 md:mb-6">
              Our Legacy
            </h2>
            <p className="text-base md:text-[16px] leading-relaxed md:leading-[24px] text-text-muted mb-6 md:mb-8">
            ...
            <div className="space-y-4 md:space-y-6">
              <div className="flex gap-4">
                <div className="text-2xl md:text-[24px] leading-8 md:leading-[32px] font-semibold text-accent">15+</div>
                <div>
                  <div className="text-[12px] md:text-[14px] leading-[16px] md:leading-[20px] tracking-[0.05em] font-semibold text-text uppercase">
                    Years Experience
                  </div>
                  <div className="text-[11px] md:text-[12px] leading-[14px] md:leading-[16px] font-medium text-text-muted">
                    Industry veteran leadership.
                  </div>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="text-2xl md:text-[24px] leading-8 md:leading-[32px] font-semibold text-secondary">120+</div>
                <div>
                  <div className="text-[12px] md:text-[14px] leading-[16px] md:leading-[20px] tracking-[0.05em] font-semibold text-text uppercase">
                    Projects Delivered
                  </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-white border border-border overflow-hidden rounded-sm">
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-xs md:text-[12px] leading-[14px] md:leading-[16px] font-medium text-text-muted">
      ...
      <section className="py-12 md:py-[80px]">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 md:mb-12 gap-4">
          <div>
            <h2 className="text-2xl md:text-[32px] leading-8 md:leading-[40px] tracking-[-0.01em] font-bold text-text uppercase">
              The Leadership
            </h2>
            <p className="text-base md:text-[16px] leading-relaxed md:leading-[24px] text-text-muted">
              Driven by expertise, led by precision.
            </p>
          </div>
          <div className="hidden md:block">
            <span className="text-[11px] md:text-[12px] leading-[14px] md:leading-[16px] font-medium text-text-muted uppercase tracking-widest">
              Stoke-On-Trent HQ
            </span>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          <div className="text-center group">
            <div className="aspect-square bg-surface mb-3 md:mb-4 overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-500 rounded-sm">
              <Image
            ...
            <h4 className="text-[13px] md:text-[14px] leading-[18px] md:leading-[20px] tracking-[0.05em] font-semibold text-text uppercase">
              David Harrison
            </h4>
